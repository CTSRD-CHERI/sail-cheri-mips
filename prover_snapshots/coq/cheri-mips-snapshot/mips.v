...
: Exception :=
   ...
   let l__20 := arg_ in
   if sumbool_of_bool ((Z.eqb l__20 0)) then Interrupt
   else if sumbool_of_bool ((Z.eqb l__20 1)) then TLBMod
   else if sumbool_of_bool ((Z.eqb l__20 2)) then TLBL
   else if sumbool_of_bool ((Z.eqb l__20 3)) then TLBS
   else if sumbool_of_bool ((Z.eqb l__20 4)) then AdEL
   else if sumbool_of_bool ((Z.eqb l__20 5)) then AdES
   else if sumbool_of_bool ((Z.eqb l__20 6)) then Sys
   else if sumbool_of_bool ((Z.eqb l__20 7)) then Bp
   else if sumbool_of_bool ((Z.eqb l__20 8)) then ResI
   else if sumbool_of_bool ((Z.eqb l__20 9)) then CpU
   else if sumbool_of_bool ((Z.eqb l__20 10)) then Ov
   else if sumbool_of_bool ((Z.eqb l__20 11)) then Tr
   else if sumbool_of_bool ((Z.eqb l__20 12)) then C2E
   else if sumbool_of_bool ((Z.eqb l__20 13)) then C2Trap
   else if sumbool_of_bool ((Z.eqb l__20 14)) then XTLBRefillL
   else if sumbool_of_bool ((Z.eqb l__20 15)) then XTLBRefillS
   else if sumbool_of_bool ((Z.eqb l__20 16)) then XTLBInvL
   else if sumbool_of_bool ((Z.eqb l__20 17)) then XTLBInvS
   else MCheck.
...
Definition set_CP0EPC (v : mword 64) 
: M (unit) :=
   
   write_reg CP0EPC_ref v >> (skip tt)  : M (unit).
...
: MemAccessType :=
   ...
   let l__18 := arg_ in
   if sumbool_of_bool ((Z.eqb l__18 0)) then Instruction
   else if sumbool_of_bool ((Z.eqb l__18 1)) then LoadData
   else StoreData.
...
: AccessLevel :=
   ...
   let l__16 := arg_ in
   if sumbool_of_bool ((Z.eqb l__16 0)) then User
   else if sumbool_of_bool ((Z.eqb l__16 1)) then Supervisor
   else Kernel.
...
: M (AccessLevel) :=
   ...
   (if sumbool_of_bool (w__2) then returnm (Kernel  : AccessLevel)
      ...
      let p__38 := _get_StatusReg_KSU w__3 in
      let b__0 := p__38 in
...
Definition checkCP0AccessHook '(tt : unit)  : M (unit) :=  returnm (tt  : unit).
...
: decode_failure :=
   ...
   let l__13 := arg_ in
   if sumbool_of_bool ((Z.eqb l__13 0)) then no_matching_pattern
   else if sumbool_of_bool ((Z.eqb l__13 1)) then unsupported_instruction
   else if sumbool_of_bool ((Z.eqb l__13 2)) then illegal_instruction
   else internal_error.
...
: Comparison :=
   ...
   let l__6 := arg_ in
   if sumbool_of_bool ((Z.eqb l__6 0)) then EQ'
   else if sumbool_of_bool ((Z.eqb l__6 1)) then NE
   else if sumbool_of_bool ((Z.eqb l__6 2)) then GE
   else if sumbool_of_bool ((Z.eqb l__6 3)) then GEU
   else if sumbool_of_bool ((Z.eqb l__6 4)) then GT'
   else if sumbool_of_bool ((Z.eqb l__6 5)) then LE
   else if sumbool_of_bool ((Z.eqb l__6 6)) then LT'
   else LTU.
...
: WordType :=
   ...
   let l__3 := arg_ in
   if sumbool_of_bool ((Z.eqb l__3 0)) then B
   else if sumbool_of_bool ((Z.eqb l__3 1)) then H
   else if sumbool_of_bool ((Z.eqb l__3 2)) then W
   else D.
...
: WordTypeUnaligned :=
   ...
   let l__0 := arg_ in
   if sumbool_of_bool ((Z.eqb l__0 0)) then WL
   else if sumbool_of_bool ((Z.eqb l__0 1)) then WR
   else if sumbool_of_bool ((Z.eqb l__0 2)) then DL
   else DR.
...
: M ((mword 64 * bool)) :=
   ...
   (if ((eq_vec b__0 (vec_of_bits [B1;B1]  : mword (63 - 62 + 1)))) then
      ...
      assert_exp' false "Pattern match failure at mips_tlb.sail 111:66 - 122:5" >>= fun _ => exit tt) >>= fun '((requiredLevel, addr)
...
: M (unit) :=
   ...
   (if ((eq_vec b__12 (vec_of_bits [B0;B0]  : mword (1 - 0 + 1)))) then
      ...
      assert_exp' false "Pattern match failure at mips_insts.sail 1277:12 - 1283:15" >>= fun _ =>
      exit tt)
    : M (unit).
...
: M (unit) :=
   ...
   (if ((eq_vec b__8 (vec_of_bits [B0;B0]  : mword (1 - 0 + 1)))) then
      ...
      assert_exp' false "Pattern match failure at mips_insts.sail 1257:12 - 1263:13" >>= fun _ =>
      exit tt)
    : M (unit).
...
: M (unit) :=
   ...
   (if ((eq_vec b__40 (vec_of_bits [B0;B0;B0]  : mword (2 - 0 + 1)))) then
      ...
      assert_exp' false "Pattern match failure at mips_insts.sail 1373:12 - 1383:13" >>= fun _ =>
      exit tt)
    : M (unit).
...
: M (unit) :=
   ...
   (if ((eq_vec b__32 (vec_of_bits [B0;B0;B0]  : mword (2 - 0 + 1)))) then
      ...
      assert_exp' false "Pattern match failure at mips_insts.sail 1347:12 - 1357:13" >>= fun _ =>
      exit tt)
    : M (unit).
...
: M (unit) :=
   ...
   (if ((eq_vec b__4 (vec_of_bits [B0;B0]  : mword (1 - 0 + 1)))) then
      ...
      assert_exp' false "Pattern match failure at mips_insts.sail 1236:32 - 1242:15" >>= fun _ =>
...
: M (unit) :=
   ...
   (if ((eq_vec b__0 (vec_of_bits [B0;B0]  : mword (1 - 0 + 1)))) then
      ...
      assert_exp' false "Pattern match failure at mips_insts.sail 1216:32 - 1222:8" >>= fun _ =>
      exit tt) >>= fun result : bits 32 =>
   (wGPR rt (mips_sign_extend 64 result))
    : M (unit).
...
: M (unit) :=
   ...
   (if ((eq_vec b__24 (vec_of_bits [B0;B0;B0]  : mword (2 - 0 + 1)))) then
      ...
      assert_exp' false "Pattern match failure at mips_insts.sail 1323:20 - 1333:15" >>= fun _ =>
...
: M (unit) :=
   ...
   (if ((eq_vec b__16 (vec_of_bits [B0;B0;B0]  : mword (2 - 0 + 1)))) then
      ...
      assert_exp' false "Pattern match failure at mips_insts.sail 1298:19 - 1308:15" >>= fun _ =>
      exit tt) >>= fun w__9 : mword 64 =>
   (wGPR rt w__9)
    : M (unit).
