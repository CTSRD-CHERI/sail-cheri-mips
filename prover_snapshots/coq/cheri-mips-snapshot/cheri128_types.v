...
Arguments CapCauseReg : clear implicits.
Notation "{[ r 'with' 'CapCauseReg_CapCauseReg_chunk_0' := e ]}" :=
  {| CapCauseReg_CapCauseReg_chunk_0 := e |} (only parsing).
...
forall (x y : Capability), Decidable (x = y).
 intros [x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 x21].
 intros [y0 y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12 y13 y14 y15 y16 y17 y18 y19 y20 y21].
...
Notation "{[ r 'with' 'Capability_tag' := e ]}" :=
  match r with Build_Capability _ f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability e f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_uperms' := e ]}" :=
  match r with Build_Capability f0 _ f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 e f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_set_CID' := e ]}" :=
  match r with Build_Capability f0 f1 _ f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 e f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_access_system_regs' := e ]}" :=
  match r with Build_Capability f0 f1 f2 _ f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 e f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_unseal' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 _ f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 e f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_ccall' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 _ f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 e f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_seal' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 _ f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 e f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_store_local_cap' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 _ f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 e f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_store_cap' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 _ f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 e f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_load_cap' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 _ f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 e f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_store' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 _ f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 e f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_load' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 _ f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 e f12 f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_permit_execute' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 _ f13 f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 e f13 f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_global' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 _ f14 f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 e f14 f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_reserved' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 _ f15 f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 e f15 f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_internal_e' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 _ f16 f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 e f16 f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_E' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 _ f17 f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 e f17 f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_sealed' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 _ f18 f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 e f18 f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_B' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 _ f19 f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 e f19 f20 f21
      end.
Notation "{[ r 'with' 'Capability_T' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 _ f20 f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 e f20 f21
      end.
Notation "{[ r 'with' 'Capability_otype' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 _ f21 =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 e f21
      end.
Notation "{[ r 'with' 'Capability_address' := e ]}" :=
  match r with Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 _ =>
    Build_Capability f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 e
      end.
...
Definition CapBits  : Type := bits 128.

Definition CapRegEnc  : Type := bits 5.

Definition CapRegOrDDCEnc  : Type := bits 5.

Definition CapHwrEnc  : Type := bits 5.
...
Inductive ast  :=
  ...
  | CGetFlags : (regno * regno) -> ast
  | CGetAndAddr : (regno * regno * regno) -> ast
  | CGetPCC : regno -> ast
  | CGetPCCSetOffset : (regno * regno) -> ast
  | CGetPCCIncOffset : (regno * regno) -> ast
  | CGetPCCSetAddr : (regno * regno) -> ast
  | CGetCause : regno -> ast
  | CSetCause : regno -> ast
  | CGetCID : regno -> ast
  | CSetCID : regno -> ast
  | CRAP : (regno * regno) -> ast
  | CRAM : (regno * regno) -> ast
  | CReadHwr : (regno * regno) -> ast
  | CWriteHwr : (regno * regno) -> ast
  | CAndPerm : (regno * regno * regno) -> ast
  | CSetFlags : (regno * regno * regno) -> ast
  ...
  | CSetAddr : (regno * regno * regno) -> ast
  | CAndAddr : (regno * regno * regno) -> ast
...
Definition CapCauseReg_of_regval (merge_var : register_value) : option CapCauseReg :=
   match merge_var with | Regval_CapCauseReg v => Some v | _ => None end.
...
Definition ErrorEPCC_ref := {|
  name := "ErrorEPCC";
  read_from := (fun s => s.(ErrorEPCC));
  write_to := (fun v s => ({[ s with ErrorEPCC := v ]}));
...
Definition CPLR_ref := {|
  name := "CPLR";
  read_from := (fun s => s.(CPLR));
  write_to := (fun v s => ({[ s with CPLR := v ]}));
  of_regval := (fun v => Capability_of_regval v);
  regval_of := (fun v => regval_of_Capability v) |}.

Definition CULR_ref := {|
  name := "CULR";
  read_from := (fun s => s.(CULR));
  write_to := (fun v s => ({[ s with CULR := v ]}));
  of_regval := (fun v => Capability_of_regval v);
  regval_of := (fun v => regval_of_Capability v) |}.
...
Definition get_regval (reg_name : string) (s : regstate) : option register_value :=
  ...
  if string_dec reg_name "ErrorEPCC" then Some (ErrorEPCC_ref.(regval_of) (ErrorEPCC_ref.(read_from) s)) else
  ...
  if string_dec reg_name "CPLR" then Some (CPLR_ref.(regval_of) (CPLR_ref.(read_from) s)) else
  if string_dec reg_name "CULR" then Some (CULR_ref.(regval_of) (CULR_ref.(read_from) s)) else
...
Definition set_regval (reg_name : string) (v : register_value) (s : regstate) : option regstate :=
  ...
  if string_dec reg_name "ErrorEPCC" then option_map (fun v => ErrorEPCC_ref.(write_to) v s) (ErrorEPCC_ref.(of_regval) v) else
  ...
  if string_dec reg_name "CPLR" then option_map (fun v => CPLR_ref.(write_to) v s) (CPLR_ref.(of_regval) v) else
  if string_dec reg_name "CULR" then option_map (fun v => CULR_ref.(write_to) v s) (CULR_ref.(of_regval) v) else
