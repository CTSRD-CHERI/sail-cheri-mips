...
Notation "{[ r 'with' 'TLBEntry_TLBEntry_chunk_1' := e ]}" := {|
  TLBEntry_TLBEntry_chunk_1 := e;
  TLBEntry_TLBEntry_chunk_0 := TLBEntry_TLBEntry_chunk_0 r
  |}.
Notation "{[ r 'with' 'TLBEntry_TLBEntry_chunk_0' := e ]}" := {|
  TLBEntry_TLBEntry_chunk_0 := e;
  TLBEntry_TLBEntry_chunk_1 := TLBEntry_TLBEntry_chunk_1 r
  |}.
...
Notation "{[ r 'with' 'Capability_tag' := e ]}" := {|
  Capability_tag := e;
  Capability_padding := Capability_padding r;
  Capability_otype := Capability_otype r;
  Capability_uperms := Capability_uperms r;
  Capability_perm_reserved12_14 := Capability_perm_reserved12_14 r;
  ...
  Capability_base := Capability_base r;
  Capability_length := Capability_length r
  |}.
Notation "{[ r 'with' 'Capability_padding' := e ]}" := {|
  Capability_padding := e;
...
Notation "{[ r 'with' 'Capability_perm_reserved12_14' := e ]}" := {|
  Capability_perm_reserved12_14 := e;
  Capability_tag := Capability_tag r;
  Capability_padding := Capability_padding r;
  Capability_otype := Capability_otype r;
  Capability_uperms := Capability_uperms r;
...
Notation "{[ r 'with' 'CID' := e ]}" := {|
  ...
  C01 := C01 r;
  DDC := DDC r;
  DelayedPCC := DelayedPCC r;
  NextPCC := NextPCC r;
  PCC := PCC r;
  UART_RVALID := UART_RVALID r;
  UART_RDATA := UART_RDATA r;
  UART_WRITTEN := UART_WRITTEN r;
  UART_WDATA := UART_WDATA r;
  GPR := GPR r;
  LO := LO r;
  HI := HI r;
  DelayedPC := DelayedPC r;
  BranchPending := BranchPending r;
  InBranchDelay := InBranchDelay r;
  NextInBranchDelay := NextInBranchDelay r;
  CP0Status := CP0Status r;
  CP0ConfigK0 := CP0ConfigK0 r;
  CP0UserLocal := CP0UserLocal r;
  CP0HWREna := CP0HWREna r;
  CP0Count := CP0Count r;
  CP0BadInstrP := CP0BadInstrP r;
  CP0BadInstr := CP0BadInstr r;
  LastInstrBits := LastInstrBits r;
  CurrentInstrBits := CurrentInstrBits r;
  CP0BadVAddr := CP0BadVAddr r;
  CP0LLAddr := CP0LLAddr r;
  CP0LLBit := CP0LLBit r;
  CP0Cause := CP0Cause r;
  CP0Compare := CP0Compare r;
  TLBEntry63 := TLBEntry63 r;
  TLBEntry62 := TLBEntry62 r;
  TLBEntry61 := TLBEntry61 r;
  TLBEntry60 := TLBEntry60 r;
  TLBEntry59 := TLBEntry59 r;
  TLBEntry58 := TLBEntry58 r;
  TLBEntry57 := TLBEntry57 r;
  TLBEntry56 := TLBEntry56 r;
  TLBEntry55 := TLBEntry55 r;
  TLBEntry54 := TLBEntry54 r;
  TLBEntry53 := TLBEntry53 r;
  TLBEntry52 := TLBEntry52 r;
  TLBEntry51 := TLBEntry51 r;
  TLBEntry50 := TLBEntry50 r;
  TLBEntry49 := TLBEntry49 r;
  TLBEntry48 := TLBEntry48 r;
  TLBEntry47 := TLBEntry47 r;
  TLBEntry46 := TLBEntry46 r;
  TLBEntry45 := TLBEntry45 r;
  TLBEntry44 := TLBEntry44 r;
  TLBEntry43 := TLBEntry43 r;
  TLBEntry42 := TLBEntry42 r;
  TLBEntry41 := TLBEntry41 r;
  TLBEntry40 := TLBEntry40 r;
  TLBEntry39 := TLBEntry39 r;
  TLBEntry38 := TLBEntry38 r;
  TLBEntry37 := TLBEntry37 r;
  TLBEntry36 := TLBEntry36 r;
  TLBEntry35 := TLBEntry35 r;
  TLBEntry34 := TLBEntry34 r;
  TLBEntry33 := TLBEntry33 r;
  TLBEntry32 := TLBEntry32 r;
  TLBEntry31 := TLBEntry31 r;
  TLBEntry30 := TLBEntry30 r;
  TLBEntry29 := TLBEntry29 r;
  TLBEntry28 := TLBEntry28 r;
  TLBEntry27 := TLBEntry27 r;
  TLBEntry26 := TLBEntry26 r;
  TLBEntry25 := TLBEntry25 r;
  TLBEntry24 := TLBEntry24 r;
  TLBEntry23 := TLBEntry23 r;
  TLBEntry22 := TLBEntry22 r;
  TLBEntry21 := TLBEntry21 r;
  TLBEntry20 := TLBEntry20 r;
  TLBEntry19 := TLBEntry19 r;
  TLBEntry18 := TLBEntry18 r;
  TLBEntry17 := TLBEntry17 r;
  TLBEntry16 := TLBEntry16 r;
  TLBEntry15 := TLBEntry15 r;
  TLBEntry14 := TLBEntry14 r;
  TLBEntry13 := TLBEntry13 r;
  TLBEntry12 := TLBEntry12 r;
  TLBEntry11 := TLBEntry11 r;
  TLBEntry10 := TLBEntry10 r;
  TLBEntry09 := TLBEntry09 r;
  TLBEntry08 := TLBEntry08 r;
  TLBEntry07 := TLBEntry07 r;
  TLBEntry06 := TLBEntry06 r;
  TLBEntry05 := TLBEntry05 r;
  TLBEntry04 := TLBEntry04 r;
  TLBEntry03 := TLBEntry03 r;
  TLBEntry02 := TLBEntry02 r;
  TLBEntry01 := TLBEntry01 r;
  TLBEntry00 := TLBEntry00 r;
  TLBXContext := TLBXContext r;
  TLBEntryHi := TLBEntryHi r;
  TLBWired := TLBWired r;
  TLBPageMask := TLBPageMask r;
  TLBContext := TLBContext r;
  TLBEntryLo1 := TLBEntryLo1 r;
  TLBEntryLo0 := TLBEntryLo0 r;
  TLBRandom := TLBRandom r;
  TLBIndex := TLBIndex r;
  TLBProbe := TLBProbe r;
  NextPC := NextPC r;
  PC := PC r
...
Definition bitvector_16_dec_of_regval (merge_var : register_value) 
: option (mword 16) :=
   
   match merge_var with | Regval_bitvector_16_dec (v) => Some (v) | _ => None end.

Definition regval_of_bitvector_16_dec (v : mword 16) 
: register_value :=
   
   Regval_bitvector_16_dec
     (v).

Definition bitvector_1_dec_of_regval (merge_var : register_value) 
: option (mword 1) :=
...
Definition bitvector_3_dec_of_regval (merge_var : register_value) 
: option (mword 3) :=
...
Definition bitvector_6_dec_of_regval (merge_var : register_value) 
: option (mword 6) :=
...
Definition bitvector_8_dec_of_regval (merge_var : register_value) 
: option (mword 8) :=
